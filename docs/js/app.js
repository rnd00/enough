...
const defaults={month:today.slice(0,7),start:key(tomorrow),hours:82,completed:0,vacationHours:0,mode:'remaining',region:'JP',subdivision:'',weekStartsOn:1,weekdays:[1,2,3,4,5],vacation:[],custom:{},blocks:[],limit:8};
