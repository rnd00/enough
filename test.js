...
import {calculate,monthDays,overlaps,distribute,planWithLunch,startOfWeek,holidayMap,plannedMessage} from './calendar.js';
...
test('SEA calendars cover every country and filter Malaysia state holidays',()=>{
  const bundle=JSON.parse(readFileSync(new URL('./sea-holidays.json',import.meta.url),'utf8'));
